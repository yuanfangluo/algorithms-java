package Algorithms._1_经典数据结构算法.手把手刷数组算法.双指针技巧秒杀七道数组题目.左右指针.回文串判断;
...
public class _5_最长回文子串 {
    ...
    public static void main(String[] args) {
        _5_最长回文子串 foo = new _5_最长回文子串();
        System.out.println(foo.palindrome("babad", 1, 1));
        System.out.println(foo.palindrome("cbbd", 1, 2));
